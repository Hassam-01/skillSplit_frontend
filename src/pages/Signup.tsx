...
const Signup = () => {
  ...
  return (
    <div style={{ 
      ...
      backgroundImage: 'radial-gradient(circle at 20% 20%, var(--color-surface-container-low) 0%, transparent 40%), radial-gradient(circle at 80% 80%, var(--color-surface-container-high) 0%, transparent 40%)'
    }}>
      <div style={{ 
        width: '100%', 
        maxWidth: '440px', 
